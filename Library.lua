...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        SearchBox = New("TextBox", {
            ...
            BackgroundColor3 = "BackgroundColor",
            PlaceholderText = "Search...",
            Position = UDim2.new(0.3, 12, 0.5, 0),
            Size = UDim2.new(0.7, -64, 1, -16),
            TextSize = 14,
            TextXAlignment = Enum.TextXAlignment.Left,
            Parent = TopBar,
        })
    ...
    function Window:AddTab(Name: string, Icon)
        ...
        do
            ...
            -- UI List Layout Padding Adjustments
            New("UIPadding", {
                PaddingTop = UDim.new(0, 4),
                PaddingLeft = UDim.new(0, 6),
                PaddingRight = UDim.new(0, 6),
            ...
            Tabs.UIListLayout.Padding = UDim.new(0, 4)
        ...
        function Tab:Hover(Hovering)
            ...
            TweenService:Create(TabLabel, Library.TweenInfo, {
                ...
                Position = Hovering and UDim2.fromOffset(40, 0) or UDim2.fromOffset(36, 0),
            }):Play()
            if TabIcon then
        ...
        function Tab:Show()
            ...
            if Tab.Marker then Tab.Marker.Visible = true end
            TweenService:Create(TabButton, Library.TweenInfo, {
                BackgroundTransparency = 0,
            }):Play()
            TweenService:Create(TabLabel, Library.TweenInfo, {
            ...
            TabContainer.Position = UDim2.fromScale(0.05, 0)
            TweenService:Create(TabContainer, Library.NotifyTweenInfo, {
        ...
        function Tab:Hide()
            if Tab.Marker then Tab.Marker.Visible = false end
            TweenService:Create(TabButton, Library.TweenInfo, {
                BackgroundTransparency = 1,
            }):Play()
            TweenService:Create(TabLabel, Library.TweenInfo, {
